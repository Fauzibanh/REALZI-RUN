...
${Array.from(room.jawaban, (jawaban, index) => {
    ...
    ${isSurender ? '' : `Perfect Player`}`.trim()
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            } else m.reply('*JAWABAN SALAH KAK!!!*')
        }
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YOUTUBE',
                                    url: 'https://youtube.com/channel/UC-iDjlzju2qTWjoyHmlrG_Q'
                                }
                            }, {
                                callButton: {
                                    displayText: 'NOMBER OWNER',
